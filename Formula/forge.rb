class Forge < Formula
  ...
  # anthropic + pydantic + jiter require Rust toolchain for pydantic-core/jiter builds
  # For now, forge runs with debug-echo provider only (offline); users install anthropic SDK separately if needed
